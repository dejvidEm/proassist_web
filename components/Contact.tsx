...
export default function Contact() {
  return (
    <section id='contact' className='py-28 text-center mb-20 sm:mb-28 w-[min(100% ,38rem)] max-w-[800px] mx-auto'>
      ...
      <form>
        <input name='name' type="name" required maxLength={500} placeholder='Meno Priezvisko' className='mx-8 px-4 mx-auto w-[320px] sm:w-[400px] md:w-[800px] h-14 rounded-lg borderBlack dark:bg-white/80 focus:dark:bg-white/100 transition-all dark:outline-none border-2 mb-3'/>
        <input name='mobile' type="tel" required maxLength={500} placeholder='Telefónne číslo' className='mx-8 px-4 mx-auto w-[320px] sm:w-[400px] md:w-[800px] h-14 rounded-lg borderBlack dark:bg-white/80 focus:dark:bg-white/100 transition-all dark:outline-none border-2 mb-3'/>
