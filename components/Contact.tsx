...
export default function Contact() {
  return (
    <section id='contact' className='py-28 text-center mb-20 sm:mb-28 w-[min(100% ,38rem)] '>
      ...
      <p className='text-gray-700 -mt-3 mb-8 mx-4'>Prosím kontaktujte Nás prostredníctvom formuláru nižšie alebo nám zavolajte na <a className='underline font-bold' href="mailto:uniquesolutionskontakt@gmail.com">0918 722 720</a></p>
      <form>
